...
from model.PreprocessLayer import PreprocessLayer
...
class Model(nn.Module):
    def __init__(self,
        ...
        # Preprocessing layer
        self.preprocess = PreprocessLayer(num_frames, landmarks_to_include, drop_z)
    ...
    def forward(self, x):
        x = self.preprocess(x, self.dummy_param.device)
